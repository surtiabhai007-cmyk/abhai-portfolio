    ...
    <section id="about" className="py-12 animate-fadeIn">
      ...
      <div className="max-w-2xl mx-auto p-6 leading-relaxed text-base md:text-lg text-gray-700">
        ...
        <p>
          ...
          I am currently working as a <strong>Project Coordinator at TrooTech Business Solutions</strong> in Ahmedabad.
        </p>
        ...
        <p className="mt-4">
          ...
          I have successfully managed cross-functional teams and delivered enterprise-grade solutions aligned with business goals.
        </p>
        ...
        <p className="mt-4">
          ...
          I regularly work with tools including <strong>Jira</strong>, <strong>Trello</strong>, <strong>ClickUp</strong>, and <strong>Asana</strong>.
        </p>
