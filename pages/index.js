          ...
          <section id="experience" ref={experienceRef} data-aos="fade-up">
            ...
            <div className="relative border-l-4 border-cyan-500 ml-10">
              {displayedExperience.map((exp, i) => (
                ...
                >
                  {/* Numbered circle */}
                  <div
                    className="absolute -left-10 top-1 flex items-center justify-center w-6 h-6 bg-cyan-500 text-black font-bold rounded-full shadow-md"
            ...
            <div className="text-center mt-6">
              <button
                ...
                className="px-6 py-2 bg-cyan-500 text-black rounded-lg font-semibold shadow-md hover:bg-cyan-400 hover:scale-105 hover:shadow-lg transition-transform duration-300"
              >
